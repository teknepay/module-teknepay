...
class Config implements \Magento\Payment\Model\Method\ConfigInterface
{
    ...
    {
        \Teknepay\Settings::$profileId  = $this->getGatewayProfileId();
        \Teknepay\Settings::$gatewayUsername  = $this->getGatewayUsername();
        \Teknepay\Settings::$gatewayPassword  = $this->getGatewayPassword();
        \Teknepay\Settings::$gatewayBase = $this->getDomainGateway();
        \Teknepay\Settings::$debugEnabled = $this->getLoggingStatus();
    }
    ...
    {
        return $this->getValue('gateway_url');
    }

    /**
     * Get Method Domain Gateway Profile ID Setting
     * @return null|string
     */
    ...
    /**
     * Get Method Domain Gateway Username Setting
     * @return null|string
     */
    public function getGatewayUsername()
    {
     ...
     /**
     * Get Method Domain Gateway Password Setting
     * @return null|string
     */
    public function getGatewayPassword()
    {
        return $this->getValue('gateway_password');
    }

   /**
     * Get Method Domain Gateway Generate Invoice Setting
     * @return null|string
     */
    public function getGenerateInvoice()
    {
        return $this->getValue('enable_invoice');
    }

    /**
     * Get Method Domain Gateway Enable Debug Logging Setting
     * @return null|string
     */
    public function getLoggingStatus()
    {
        return $this->getValue('enable_logging');
    }
     ...
     * @return null|array
     */
    public function getEnabledCcTypes()
    {
        return array_map(
            'trim',
            explode(
                ',',
                $this->getValue('cc_types')
            )
        );
    }
