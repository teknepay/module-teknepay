...
class Eft extends \Magento\Payment\Model\Method\AbstractMethod
{
    use \Teknepay\Teknepay\Model\Traits\OnlinePaymentMethod;

    const CODE = 'teknepay_eft';
    /**
    ...
    protected $_supportedCurrencyCodes = array('CAD');
    ...
    protected function checkout($data)
    {
      ...
      $transaction = new \Teknepay\GetEftPaymentToken;
      ...
      $transaction->paymentDetails->setTransitNumber($data['transaction']['TransitNumber']);
      $transaction->paymentDetails->setInstitutionNumber($data['transaction']['InstitutionNumber']);
      ...
      Debugger::info($response, "RESPONSE INTO Eft Model: [" . __FUNCTION__ . " in file " . __FILE__ . "]");
    ...
    public function order(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
		...
		$data = [
                    ...
                    "transaction" => [
                                        ...
                                        "TransitNumber" => $checkDetails['transit_number'],
                                        "InstitutionNumber" => $checkDetails['institution_number'],
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $info->setAdditionalInformation(
            [
                'transit_number' => $data['additional_data']['transit_number'],
                'institution_number' => $data['additional_data']['institution_number'],
